...
var SshClient = require('./utils/ssh');
...
var FolderUploadWebpackPlugin = /** @class */ (function () {
    ...
    FolderUploadWebpackPlugin.prototype.handleScript = function (script) {
        if (os.platform() === 'win32') {
            var buffer = child_process_1.execSync(script, { stdio: 'inherit' });
        }
        else {
    ...
    FolderUploadWebpackPlugin.prototype.upload = function (compilation, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, clear, ssh, chmod, server, i, _b, _c, _i, i, _d, filesList, cl, _e, _f, _g, i_1, e_1, _h, _j, _k, i_2, dir, e_2, i;
            return __generator(this, function (_l) {
                switch (_l.label) {
                    case 0:
                        _a = this.options, clear = _a.clear, ssh = _a.ssh, chmod = _a.chmod, server = _a.server;
                        if (this.options.before && this.options.before.length) {
                            for (i in this.options.before) {
                                this.handleScript(this.options.before[i]);
                            }
                        }
                        if (!(!this.options.confirmation || readline_sync_1.default.keyInYN(chalk.bold.red("\nAre you sure you want to replace the server?")))) return [3 /*break*/, 22];
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, ssh.connect(server[i])];
                    case 3:
                        _l.sent();
                        _e = [];
                    ...
                    case 5:
                        _l.trys.push([5, 7, , 8]);
                        this.log('Clearing remote folder ' + this.paths[i_1] + '* ...', chalk.red);
                        return [4 /*yield*/, ssh.exec('rm -rf ' + formatRemotePath(this.paths[i_1]) + '*')];
                    case 6:
                        _l.sent();
                        return [3 /*break*/, 8];
                    case 7:
                    ...
                    case 11:
                        ...
                        return [4 /*yield*/, ssh.exists(dir)];
                    case 12:
                        if (!!(_l.sent())) return [3 /*break*/, 15];
                        this.log('MAKE remote folder ' + dir + ' ...', chalk.green);
                        return [4 /*yield*/, ssh.mkdir(dir, true).catch(function () { return null; })];
                    case 13:
                        _l.sent();
                        return [4 /*yield*/, ssh.chmod(dir, chmod).catch(function () { return null; })];
                    case 14:
                        _l.sent();
                        _l.label = 15;
                    ...
                    case 18:
                        ...
                        return [4 /*yield*/, ssh.sendFile(filesList)];
                    case 19:
                        _l.sent();
                        this.log('end', chalk.green);
                        return [4 /*yield*/, ssh.end()];
                    case 20:
                        _l.sent();
                        _l.label = 21;
                    case 21:
    ...
    FolderUploadWebpackPlugin.prototype.createSimlinks = function (options, inputPath, clear) {
        if (options.force || fs.existsSync(inputPath)) {
            ...
            this.log('Symlink path: ' + origin_1, chalk.green);
            try {
                if (clear) {
    ...
    FolderUploadWebpackPlugin.prototype.log = function (text, formatter) {
        if (formatter === void 0) { formatter = chalk.blue; }
